...
python3 mode_key.py 
```
You can input 't' in keyboard terminal to make the drone takeoff. When hovering at the desire height, inputting 'o' to switch the drone to Offboard mode. Then, the drone will fly to follow the trajectory when it is published (see Part 3).
